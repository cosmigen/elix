 ...
 */
export function broadcastToolResult(payload) {
        ...
        switch (action) {
            case 'list': {
                ...
                if (result.apps.length === 0) {
                    ...
                    for (const app of result.apps) {
                        ...
                        if (app.windowId)
                            p.log.message(`    Active Window ID: ${app.windowId}`);
                        if (app.url)
            ...
            case 'policy': {
                ...
                if (policyAction === 'view') {
                    ...
                    if (p.isCancel(permToToggle) || !permToToggle.trim())
                        break;
