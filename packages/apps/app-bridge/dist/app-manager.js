...
export class ElixAppManager extends EventEmitter {
     ...
     */
    async rebuildDemoApps(demoAppsDir) {
        ...
        if (fs.existsSync(notesSrc)) {
            ...
            const verifyAndPatch = async (filePath) => {
                if (!fs.existsSync(filePath) || !fs.existsSync(srcIndex))
                    return;
     ...
     */
    async openApp(appId, initialRoute, windowOverrides) {
