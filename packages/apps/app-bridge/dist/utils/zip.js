...
export class ElixZip {
     ...
     */
    readAsText(nameOrEntry, encoding = 'utf-8') {
     ...
     */
    extractAllTo(targetDir, _overwrite = true) {
     ...
     */
    async extractAllToAsync(targetDir) {
        const resolvedTarget = path.resolve(targetDir);
 ...
 */
export function packageFolderToZip(folderPath, outputZipPath) {
