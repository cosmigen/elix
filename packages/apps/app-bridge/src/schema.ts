 ...
 */
export const ElixAppWindowConfigSchema: Schema<ElixAppWindowConfig> = Schema.object<ElixAppWindowConfig>({
 ...
 */
export const ElixAppAuthorObjectSchema: Schema<ElixAppAuthorObject> = Schema.object<ElixAppAuthorObject>({
 ...
 */
export const ElixAppAuthorSchema: Schema<ElixAppAuthor> = Schema.union<ElixAppAuthor>([
 ...
 */
export const ElixAppPermissionSchema: Schema<ElixAppPermission> = Schema.string()
  .pattern(/^[a-z0-9_-]+:[a-z0-9_*.-]+$/)
  .description('Permission descriptor in namespace:action format (e.g. fs:read, net:http)') as Schema<ElixAppPermission>;

/**
 * Schemastery definition for JSONSchemaProperty (Capability Parameters)
 */
export const JSONSchemaPropertySchema: Schema<JSONSchemaProperty> = (Schema.object({
  type: Schema.union([
    Schema.string(),
...
}).description('JSON Schema parameter definition')) as unknown as Schema<JSONSchemaProperty>;

/**
 * Schemastery definition for JSONSchemaObject
 */
export const JSONSchemaObjectSchema: Schema<JSONSchemaObject> = (Schema.object({
  type: Schema.const('object' as const).default('object' as const),
  properties: Schema.dict(JSONSchemaPropertySchema).default({}),
  required: Schema.array(Schema.string()),
  additionalProperties: Schema.union([Schema.boolean(), Schema.any()]),
}).required().description('JSON Schema parameters object')) as unknown as Schema<JSONSchemaObject>;

/**
 * Schemastery definition for ElixAppCapability
 */
export const ElixAppCapabilitySchema: Schema<ElixAppCapability> = (Schema.object({
...
}).description('Capability exposed for Cordis tool registration')) as unknown as Schema<ElixAppCapability>;

/**
 * Schemastery definition for the full ElixAppManifest (.ELIXAPP / elix.app.json)
 */
export const ElixAppManifestSchema: Schema<ElixAppManifest> = (Schema.object({
  id: Schema.string()
    .required()
...
}).description('ELIX Native Application Manifest Specification')) as unknown as Schema<ElixAppManifest>;
